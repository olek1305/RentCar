...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'rental_time_hour' => ['required', 'string', 'size:2', 'regex:/^(0[6-9]|1[0-9]|20)$/'],
            'rental_time_minute' => ['required', 'string', 'size:2', 'regex:/^[0-5][0-9]$/'],
            'return_time_hour' => ['required', 'string', 'size:2', 'regex:/^(0[6-9]|1[0-9]|20)$/'],
            'return_time_minute' => ['required', 'string', 'size:2', 'regex:/^[0-5][0-9]$/'],
